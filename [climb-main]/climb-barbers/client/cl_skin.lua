...
function GetMaxVals()
	...
	local data = {
		...
		hair_1			= GetNumberOfPedDrawableVariations		(player1, 2) - 1,
...
RegisterNUICallback('updateSkin', function(data)
	...
	if v == true then
		...
		TriggerServerEvent("CLIMB:saveFaceData",faceSaveData)
	end
end)
...
RegisterNetEvent("CLIMB:setHairstyle")
AddEventHandler("CLIMB:setHairstyle",function(hairstyle)
    if hairstyle then
...
AddEventHandler("CLIMB:openBarbershop",function()
