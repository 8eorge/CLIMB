...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Efterlysning af køretøjet er sat igang.",
        track_failed = "~y~Efterlysning af {1}~s~ ({2}) ~n~~r~Mislykket.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~y~Registeret blev tømt"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          description = "",
          seized = "~y~Dine våben er blevet beslaglagt."
        },
        items = {
          title = "Beslaglæg illegale ting",
          description = "",
          seized = "~y~Dine ulovlige genstande er blevet beslaglagt."
        }
      },
      jail = {
        title = "Fængsel",
        ...
        jailed = "~y~Fængslet.",
        unjailed = "~y~Frifundet.",
        notify_jailed = "~y~Du blev fængslet.",
        notify_unjailed = "~y~Du blev frifundet."
      },
      fine = {
        title = "Bøde",
        description = "",
        fined = "~y~Bøde ~s~{2} DKK for ~y~{1}.",
        notify_fined = "~y~Du modtog en bøde ~s~ {2} DKK for ~y~{1}.",
  ...
  phone = {
    ...
    sms = {
      ...
      notify = "BESKED~y~ {1}:~s~ ~n~{2}"
    },
    smspos = {
      notify = "SMS-Lokalisering ~y~ {1}"
    },
    service = {
      title = "Servicering",
      description = "",
  ...
  aptitude = {
    ...
    lose_exp = "Fædighed: ~y~{1}/{2} ~r~-{3} ~s~XP.",
    earn_exp = "Fædighed: ~y~{1}/{2} ~g~+{3} ~s~XP.",
    level_down = "Fædighed: ~y~{1}/{2} ~r~tabte niveau ({3}).",
    level_up = "Fædighed: ~y~{1}/{2} ~g~niveau op ({3}).",
    display = {
      group = "{1}: ",
      aptitude = "{1} (Level {3})"
    }
