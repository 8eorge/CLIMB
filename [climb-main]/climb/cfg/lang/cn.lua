...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~開始跟蹤.",
        track_failed = "~y~跟蹤 {1}~s~ ({2}) ~n~~r~失敗.",
        tracked = "跟蹤 {1} ({2})"
      },
      records = {
        show = {
    ...
    menu = {
      ...
      jail = {
        ...
        jailed = "~y~入獄.",
        unjailed = "~y~被判入獄.",
        notify_jailed = "~y~你被监禁了.",
        notify_unjailed = "~y~您已被判入獄."
      },
      fine = {
        title = "法恩",
        description = "罚款最近的玩家.",
        fined = "~y~罰款 ~s~{2} $ for~y~{1}.",
        notify_fined = "~y~你被罰款了 ~s~ {2} $ for ~y~{1}.",
        record = "[罰款] {2} $ for {1}"
      },
      store_weapons = {
        title = "儲存武器",
  ...
  aptitude = {
    title = "能力",
    description = "顯示能力.",
    lose_exp = "資質 ~y~{1}/{2} ~r~-{3} ~s~經驗.",
    earn_exp = "資質 ~y~{1}/{2} ~g~+{3} ~s~經驗.",
    level_down = "資質 ~y~{1}/{2} ~r~下降 ({3}).",
    level_up = "資質 ~y~{1}/{2} ~g~提升 ({3}).",
    display = {
      group = "{1}: ",
