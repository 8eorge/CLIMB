...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Urmarirea a inceput.",
        track_failed = "~y~Urmarirea lui {1}~s~ ({2}) ~n~~r~a esuat.",
        tracked = "Urmarit {1} ({2})"
      },
      records = {
        show = {
    ...
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Armele tale au fost confiscate."
        },
        items = {
          title = "Confisca obiecte ilegale",
          description = "Confisca obiectele ilegale",
          seized = "~y~Obiectele tale ilegale au fost confiscate."
        }
      },
      jail = {
        title = "Aresteaza",
        ...
        jailed = "~y~A fost inchis.",
        unjailed = "~y~A fost eliberat.",
        notify_jailed = "~y~Ai fost inchis.",
        notify_unjailed = "~y~Ai fost eliberat."
      },
      fine = {
        title = "Amendeaza",
        description = "Amendeaza cel mai apropiat jucator.",
        fined = "~y~Ai dat amenda ~s~{2} $ pentru ~y~{1}.",
        notify_fined = "~y~Ai fost amendat ~s~ {2} $ pentru ~y~{1}.",
  ...
  aptitude = {
    ...
    lose_exp = "Abilitatea ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "Abilitatea ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "Abilitatea ~y~{1}/{2} ~r~nivel pierdut ({3}).",
    level_up = "Abilitatea ~y~{1}/{2} ~g~nivel crescut ({3}).",
    display = {
      group = "{1}: ",
