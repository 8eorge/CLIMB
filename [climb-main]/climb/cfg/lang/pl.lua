...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Namierzanie wlaczone.",
        track_failed = "~y~Namierzanie {1}~s~ ({2}) ~n~~r~ie powiodlo sie.",
    ...
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Bron zostala skonfiskowana."
        },
        items = {
          title = "Znajdz nielegalne przedmioty",
          description = "Znaleziono nielegalny przedmiot",
          seized = "~y~Skonfiskowano nielegalny przedmiot."
        }
      },
      jail = {
        title = "Wiezienie",
        ...
        jailed = "~y~Osadzony.",
        unjailed = "~y~Zwolniony.",
        notify_jailed = "~y~Zostales osadzony.",
        notify_unjailed = "~y~Zostales zwolniony."
      },
      fine = {
        title = "Mandat",
        description = "Ukaz mandatem osobe w poblizu.",
        fined = "~y~Mandat ~s~{2} $ za ~y~{1}.",
        notify_fined = "~y~Dostales mandat ~s~ {2} $ za ~y~{1}.",
        record = "[Fine] {2} $ za {1}"
      },
      store_weapons = {
        title = "Schowaj bron",
  ...
  aptitude = {
    ...
    lose_exp = "Statystyka ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "Statystyka ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "Statystyka ~y~{1}/{2} ~r~Poziom obnizony ({3}).",
    level_up = "Statystyka ~y~{1}/{2} ~g~Poziom podniesiony ({3}).",
    display = {
      group = "{1}: ",
