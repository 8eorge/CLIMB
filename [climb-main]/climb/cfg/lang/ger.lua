...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Fahrzeug wird geortet.",
        track_failed = "~y~Ortung von {1}~s~ ({2}) ~n~~r~fehlgeschlagen.",
    ...
    menu = {
      ...
      jail = {
        ...
        jailed = "~y~Verhaftet.",
        unjailed = "~y~Entlassen.",
        notify_jailed = "~y~Du wurdest verhaftet.",
        notify_unjailed = "~y~Du wurdest entlassen."
      },
      fine = {
        title = "Geldstrafe",
        description = "Stelle dem nächsten Spieler ein Bußgeld aus.",
        fined = "~y~Bußgeld über ~s~{2} € für ~y~{1}.",
        notify_fined = "~y~Bußgeld über ~s~ {2} € für ~y~{1}.",
	...
	fine = {
	  ...
	  record = "[Bußgeld] {1}€ für {2} <br />",
		...
		notify = {
		  notifyp = "~y~[Bußgeld] {1} für {2}",
		  notifynp = "~y~[Bußgeld] {1} für {2}"
		  }
	  }
  },
  emergency = {
  ...
  phone = {
    ...
    sms = {
      ...
      notify = "SMS~y~ {1}:~s~ ~n~{2}"
    },
    smspos = {
      notify = "SMS-Standort ~y~ {1}"
    },
    service = {
      title = "Dienste",
  ...
  aptitude = {
    ...
    lose_exp = "Fähigkeit ~y~{1}/{2} ~r~-{3} ~s~erf.",
    earn_exp = "Fähigkeit ~y~{1}/{2} ~g~+{3} ~s~erf.",
    level_down = "Fähigkeit ~y~{1}/{2} ~r~verschlechtert ({3}).",
    level_up = "Fähigkeit ~y~{1}/{2} ~g~verbessert ({3}).",
    display = {
      group = "{1}: ",
