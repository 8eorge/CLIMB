...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Sekimas pradėtas.",
        track_failed = "~y~Sekimas {1}~s~ ({2}) ~n~~r~nepavyko.",
        tracked = "Sekamas {1} ({2})"
      },
      records = {
        show = {
        ...
        delete = {
          ...
          deleted = "~y~Policijos įrašai ištrinti"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Tavo ginklai buvo konfiskuoti."
        },
        items = {
          title = "Konfiskuoti nelegalius",
          description = "Konfiskuoti neteisėtus daiktus",
          seized = "~y~Jūsų neteisėta medžiaga buvo konfiskuota."
        }
      },
      jail = {
        title = "Kalėjimas",
        ...
        jailed = "~y~Pasodintas.",
        unjailed = "~y~Paleistas.",
        notify_jailed = "~y~Tu buvai pasodintas į kalėjimą.",
        notify_unjailed = "~y~Tu buvai paleistas iš kalėjimo."
      },
      fine = {
        title = "Bauda",
        description = "Pasiulyti artimiausiui žaidėjui bauda.",
        fined = "~y~Sumokėjo ~s~{2} € už ~y~{1}.",
        notify_fined = "~y~Tau buvo paskirta bauda ~s~ {2} € už ~y~{1}.",
        record = "[Bauda] {2} € už {1}"
      },
      store_weapons = {
        title = "Idėti ginklus",
  ...
  aptitude = {
    ...
    lose_exp = "Įgūdis ~y~{1}/{2} ~r~-{3} ~s~prarasti exp.",
    earn_exp = "Įgūdis ~y~{1}/{2} ~g~+{3} ~s~gauti exp.",
    level_down = "Įgūdis ~y~{1}/{2} ~r~prarasti lygį ({3}).",
    level_up = "Aptitude ~y~{1}/{2} ~g~pasikelti lygį ({3}).",
    display = {
      group = "{1}: ",
