...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Spårning started.",
        track_failed = "~y~Spårning av {1}~s~ ({2}) ~n~~r~Misslyckandes.",
        tracked = "Spårad {1} ({2})"
      },
      records = {
        show = {
        ...
        delete = {
          ...
          deleted = "~y~Polisens register raderas"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Dina vapen har beslagtagits."
        },
        items = {
          title = "Gripa illegaler",
          description = "beslagtagits olagliga föremål",
          seized = "~y~Dina olagliga saker har beslagtagits."
        }
      },
      jail = {
        title = "Fängelse",
        ...
        jailed = "~y~Fängslad.",
        unjailed = "~y~Fritagen.",
        notify_jailed = "~y~Du har blivit fängslad.",
        notify_unjailed = "~y~Du har blivit Fri Släppt."
      },
      fine = {
        title = "Böter",
        description = "Bötfäll närmste spelare.",
        fined = "~y~bötfälld ~s~{2} $ for ~y~{1}.",
        notify_fined = "~y~Du har blivit bötfälld ~s~ {2} $ for ~y~{1}.",
  ...
  aptitude = {
    ...
    lose_exp = "färdigheter ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "färdigheter ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "färdigheter ~y~{1}/{2} ~r~lose level ({3}).",
    level_up = "färdigheter ~y~{1}/{2} ~g~level up ({3}).",
    display = {
      group = "{1}: ",
