...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Tracking started.",
        track_failed = "~y~Tracking of {1}~s~ ({2}) ~n~~r~Failed.",
        tracked = "Tracked {1} ({2})"
      },
      records = {
        show = {
        ...
        delete = {
          ...
          deleted = "~y~Police records deleted"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Your weapons have been seized."
        },
        items = {
          title = "الاستيلاءعلى الممنوعات",
          description = "الاستيلاء على الممنوعات من اقرب شخص",
          seized = "~y~Your illegal stuff has been seized."
        }
      },
      jail = {
        title = "Jail",
        ...
        jailed = "~y~Jailed.",
        unjailed = "~y~Unjailed.",
        notify_jailed = "~y~You have been jailed.",
        notify_unjailed = "~y~You have been unjailed."
      },
      fine = {
        title = "Fine المخالفات",
        description = "اعطاء لاقرب شخص مخالفة.",
        fined = "~y~Fined ~s~{2} $ for ~y~{1}.",
        notify_fined = "~y~You have been fined ~s~ {2} $ for ~y~{1}.",
        record = "[Fine] {2} $ for {1}"
      },
      store_weapons = {
        title = "تخزين الأسلحة",
  ...
  aptitude = {
    ...
    level_down = "Aptitude ~y~{1}/{2} ~r~lose level ({3}).",
    level_up = "Aptitude ~y~{1}/{2} ~g~level up ({3}).",
    display = {
      group = "{1}: ",
