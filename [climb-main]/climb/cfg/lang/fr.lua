  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Localisation commencée.",
        track_failed = "~y~Recherche de {1}~s~ ({2}) ~n~~r~Echouée.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~y~Dossier Néttoyez, plus aucune trâce du dossier."
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Vos arme ont été saisie."
        },
        items = {
          title = "Saisir Illegals",
          description = "Saisir les substences illegals",
          seized = "~y~vos substences illegal ont été saisie."
        }
      },
      jail = {
        title = "Emprisonner",
        ...
        jailed = "~y~emprisonez.",
        unjailed = "~y~libèré.",
        notify_jailed = "~y~Vous avez été emprisonnez.",
        notify_unjailed = "~y~Vous avez été libèré."
      },
      fine = {
        title = "Amende",
        description = "Donne un amende au joueur le plus prêt.",
        fined = "~y~amende ~s~{2} $ pour ~y~{1}.",
        notify_fined = "~y~Vous avez recu un amende de ~s~ {2} $ pour ~y~{1}.",
...
vehicle = {
  ...
  items = {
    ...
    lose_exp = "Aptitude ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "Aptitude ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "Aptitude ~y~{1}/{2} ~r~perte de level ({3}).",
    level_up = "Aptitude ~y~{1}/{2} ~g~le level monte ({3}).",
    display = {
    group = "{1}: ",
