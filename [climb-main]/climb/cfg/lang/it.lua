...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Tracciamento iniziato.",
        track_failed = "~y~Tracciamento di {1}~s~ ({2}) ~n~~r~Fallito.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~y~Registri di polizia cancellati."
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Le tue armi sono state sequestrate."
        },
        items = {
          title = "Sequestra oggetti illegali",
          description = "Sequestra gli oggetti illegali",
          seized = "~y~La tua roba illegale è stata sequestrata."
        }
      },
      jail = {
        title = "Galera",
        ...
        jailed = "~y~Carcerato.",
        unjailed = "~y~Scarcerato.",
        notify_jailed = "~y~Sei stato incarcerato.",
        notify_unjailed = "~y~Sei stato scarcerato."
      },
      fine = {
        title = "Multa",
        description = "Multa il giocatore più vicino.",
        fined = "~y~Multato di ~s~{2} € per ~y~{1}.",
        notify_fined = "~y~Sei stato multato di ~s~ {2} € per ~y~{1}.",
  ...
  aptitude = {
    ...
    lose_exp = "Attitudine ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "Attitudine ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "Attitudine ~y~{1}/{2} ~r~lose level ({3}).",
    level_up = "Attitudine ~y~{1}/{2} ~g~level up ({3}).",
    display = {
      group = "{1}: ",
