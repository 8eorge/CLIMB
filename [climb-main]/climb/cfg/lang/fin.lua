...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Jäljitys aloitettu.",
        track_failed = "~y~Jäljitys {1}~s~ ({2}) ~n~~r~Epäonnistui.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~y~Poliisi kirjaukset poistettu"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Aseesi on takavarikoitu."
        },
        items = {
          title = "Takavarkoi laittomat",
          description = "Takavarikoi laittomat esineet",
          seized = "~y~Sinun laittomat tavarasi on takavarikoitu."
        }
      },
      jail = {
        title = "Vankila",
        ...
        jailed = "~y~Vankiloitu.",
        unjailed = "~y~Poistettu vankilasta.",
        notify_jailed = "~y~Sinut on vankiloitu.",
        notify_unjailed = "~y~Sinut on poistettu vankilasta."
      },
      fine = {
        title = "Sakko",
        description = "Sakota lähintä pelaajaa.",
        fined = "~y~Sakotettu  ~s~{2} $  ~y~{1}.",
        notify_fined = "~y~Sinua on sakotettu ~s~ {2} $  ~y~{1}.",
        record = "[Sakko] {2} $  {1}"
      },
      store_weapons = {
  ...
  aptitude = {
    ...
    lose_exp = "Kyky ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "Kyky ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "kyky ~y~{1}/{2} ~r~menetä tasoa ({3}).",
    level_up = "kyky ~y~{1}/{2} ~g~taso ylös ({3}).",
    display = {
      group = "{1}: ",
