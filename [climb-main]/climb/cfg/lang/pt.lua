...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~O rastreamento começou.",
        track_failed = "~y~Rastreamento de {1}~s~ ({2}) ~n~~r~Falhou.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~y~Registros policiais eliminados"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Suas armas foram apreendidas."
        },
        items = {
          title = "Apreender os ilegais",
          description = "Apreender itens ilegais",
          seized = "~y~Seu material ilegal foi apreendido."
        }
      },
      jail = {
        title = "Cadeia",
        ...
        jailed = "~y~Preso.",
        unjailed = "~y~Solto.",
        notify_jailed = "~y~Você está sendo preso.",
        notify_unjailed = "~y~Você está sendo solto."
      },
      fine = {
        title = "Multar",
        description = "Multar jogador maís proxímo.",
        fined = "~y~Multar ~s~{2} € por ~y~{1}.",
        notify_fined = "~y~Você está sendo multado ~s~ {2} € por ~y~{1}.",
  ...
  aptitude = {
    ...
    lose_exp = "Aptidão ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "Aptidão ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "Aptidão ~y~{1}/{2} ~r~level perdido ({3}).",
    level_up = "Aptidão ~y~{1}/{2} ~g~level aumentado ({3}).",
    display = {
      group = "{1}: ",
