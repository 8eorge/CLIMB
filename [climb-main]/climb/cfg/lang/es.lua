...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Rastreo en progreso..",
        track_failed = "~y~Rastreo de {1}~s~ ({2}) ~n~~r~fallido.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~y~Antecedentes limpios."
        }
      }
    },
    menu = {
      ...
      jail = {
        ...
        jailed = "~y~Encarcela.",
        unjailed = "~y~Soltado..",
        notify_jailed = "~y~Te han encarcelado..",
        notify_unjailed = "~y~Te han soltado."
      },
      fine = {
        title = "Multar",
        description = "Multa al jugador mas cercano.",
        fined = "~y~Multado ~s~{2} $ por ~y~{1}.",
        notify_fined = "~y~Te han multado ~s~ {2} $ por ~y~{1}.",
  ...
  aptitude = {
    ...
    lose_exp = "Habilidad ~y~{1}/{2} ~r~-{3} ~s~exp.",
    earn_exp = "Habilidad ~y~{1}/{2} ~g~+{3} ~s~exp.",
    level_down = "Habilidad ~y~{1}/{2} ~r~perdida level ({3}).",
    level_up = "Habilidad ~y~{1}/{2} ~g~ganado level ({3}).",
    display = {
      group = "{1}: ",
