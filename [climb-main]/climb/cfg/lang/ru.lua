...
local lang = {
  ...
  police = {
    ...
    pc = {
      ...
      trackveh = {
        ...
        tracking = "~y~Слежение активировано.",
        track_failed = "~y~Слежение {1}~s~ ({2}) ~n~~r~ не удалось.",
      ...
      records = {
        ...
        delete = {
          ...
          deleted = "~y~Полицеский записи удалены"
        }
      }
    },
    menu = {
      ...
      seize = {
        ...
        weapons = {
          ...
          seized = "~y~Ваше оружие было изъято."
        },
        items = {
          title = "Изъять нелегал",
          description = "Изъять нелегальные предметы",
          seized = "~y~У вас был изъят нелегал."
        }
      },
      jail = {
        title = "Тюрьма",
        ...
        jailed = "~y~Посажен.",
        unjailed = "~y~Выпущен.",
        notify_jailed = "~y~Вы были посажены в Тюрьму.",
        notify_unjailed = "~y~Вы были выпущены на свободу."
      },
      fine = {
        title = "Штраф",
        description = "Оштрафовать ближайшего игрока.",
        fined = "~y~Оштрафован на ~s~{2} $ за ~y~{1}.",
        notify_fined = "~y~Вы были оштрафованы на ~s~ {2} $ за ~y~{1}.",
        record = "[Штраф] {2} $ за {1}"
      },
      store_weapons = {
  ...
  aptitude = {
    ...
    lose_exp = "Способность ~y~{1}/{2} ~r~-{3} ~s~опыт.",
    earn_exp = "Способность ~y~{1}/{2} ~g~+{3} ~s~опыт.",
    level_down = "Способность ~y~{1}/{2} ~r~уровень упал ({3}).",
    level_up = "Способность ~y~{1}/{2} ~g~уровень вырос ({3}).",
    display = {
      group = "{1}: ",
