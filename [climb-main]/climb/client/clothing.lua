RMenu.Add('CLIMBClothing', 'main', RageUI.CreateMenu("Clothing", "~y~Clothing Menu",1250,100))
RMenu.Add('CLIMBClothing', 'clothingsubmenu',  RageUI.CreateSubMenu(RMenu:Get("CLIMBClothing", "main")))
RMenu.Add('CLIMBClothing', 'changegendersubmenu',  RageUI.CreateSubMenu(RMenu:Get("CLIMBClothing", "main")))
...
RageUI.CreateWhile(1.0, true, function()
    ...
    if RageUI.Visible(RMenu:Get('CLIMBClothing', 'main')) then
        RageUI.DrawContent({ header = true, glare = true, instructionalButton = true}, function()
            RageUI.Button("Change Clothing", "", {}, true, function(Hovered, Active, Selected) end, RMenu:Get("CLIMBClothing", "clothingsubmenu"))
            RageUI.Button("Change Gender", "", {}, true, function(Hovered, Active, Selected) end, RMenu:Get("CLIMBClothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('CLIMBClothing', 'changegendersubmenu')) then 
        RageUI.DrawContent({ header = true, glare = true, instructionalButton = true}, function()
            ...
            end,RMenu:Get("CLIMBClothing", "changegendersubmenu"))
    ...
    if RageUI.Visible(RMenu:Get('CLIMBClothing', 'clothingsubmenu')) then
...
Citizen.CreateThread(function()
    while true do 
        ...
        if not MenuOpen and inMarker then 
            MenuOpen = true
            RageUI.Visible(RMenu:Get('CLIMBClothing', 'main'), true) 
            Face.Index = GetPedDrawableVariation(ped, 0)
            Face.TextureIndex = GetPedTextureVariation(ped, 0)
            Mask.Index = GetPedDrawableVariation(ped, 1)
            Mask.TextureIndex = GetPedTextureVariation(ped, 1)
        ...
        if not inMarker and MenuOpen then
            ...
            RageUI.Visible(RMenu:Get('CLIMBClothing', 'clothingsubmenu'), false)
            RageUI.Visible(RMenu:Get('CLIMBClothing', 'changegendersubmenu'), false)  
            RageUI.Visible(RMenu:Get('CLIMBClothing', 'main'), false)
            MenuOpen = false
        end
    end
end)
