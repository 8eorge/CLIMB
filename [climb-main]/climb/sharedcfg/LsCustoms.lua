--[[
CLIMB Los Santos Customs V1.2
Credits - MythicalBro and マーモット#2533 for the CLIMB version and some bug fixes
]]
...
-- Enable/disable using climb_adv_garages
LSC_Config.climb_adv_garages = false
