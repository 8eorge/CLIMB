...
function closeUI(){
    ...
    xhr.open("POST", "https://climb-time/close", true);                                                                                                                                                                                                                                                                                                                                      
    xhr.send(JSON.stringify({}));
}
function easyTimeChange(values, savesettings){
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://climb-time/change", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-time").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://climb-time/instanttime", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-weather").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://climb-time/instantweather", true);                                                                                                                                                                                                                                                                                                                                      
